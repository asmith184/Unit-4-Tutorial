...
function init() {
   ...
   document.getElementById("solve").addEventListener("click", function() {
      //remove the inline bg color styles from each cell
...
function setupPuzzle() {
   ...
   for (var i = 0; i < puzzleCells.length; i++) {
      puzzleCells[i].style.backgroundColor = "rgb(239, 207, 29)";
      //set the cell bg color in response to the mouse down event
...
function swapPuzzle(e) {
   if(confirm("You will lose all of your work on the puzzle, continue?")){
      ...
      switch (puzzleID) {
         case "puzzle1":
            document.getElementById("puzzle").innnerHTML = drawPuzzle(puzzle1Hint, puzzle1Rating, puzzle1);
            break;
         case "puzzle2":
